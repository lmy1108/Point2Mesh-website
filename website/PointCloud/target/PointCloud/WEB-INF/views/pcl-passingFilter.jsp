...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      ...
      <form class="layui-form" action="doPassingThrough">

      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">设置直通滤波时的方向（x,y,z）</label>
          <div class="layui-input-inline">
            <input value = z style="width: 50px" type="tel" name="fieldName"  autocomplete="off" class="layui-input">
          </div>
          <div class="layui-inline">
            <label class="layui-form-label">直通滤波限制参数下界</label>
            <div class="layui-input-inline">
              <input value = 0 style="width: 50px" type="tel" name="low"  autocomplete="off" class="layui-input">
            </div>
        </div>
        </div>
      </div>
        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">直滤波限制参数上界</label>
            <div class="layui-input-inline">
              <input value = 1 style="width: 50px" type="tel" name="high"  autocomplete="off" class="layui-input">
            </div>
    ...
    <a href="${pageContext.request.contextPath}/upload/${cloud}" download="${cloud}" class="layui-btn layui-btn-fluid" onclick="">下载生成的点云</a>
