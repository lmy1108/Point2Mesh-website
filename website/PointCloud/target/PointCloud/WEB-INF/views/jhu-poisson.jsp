...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      ...
      <form class="layui-form" action="getParam-j1">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-inline">
          <label class="layui-form-label">边界类型(boundary type)</label>
          <div class="layui-input-inline">
            <input value = 3 style="width: 50px" type="tel" name="type"  autocomplete="off" class="layui-input">
            <br/><blockquote class="layui-elem-quote">This integer specifies the boundary type for the finite elements. Valid values are:
              <br/>1: Free boundary constraints
              <br/>2: Dirichlet boundary constraints
              <br/>3: Neumann boundary constraints </blockquote></div>
        </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-inline">
          <label class="layui-form-label">每个点的权重(pointweight)</label>
          <div class="layui-input-inline">
            <input value = 4 style="width: 50px" type="tel" name="pointWeight"  autocomplete="off" class="layui-input">
         <br/>   <blockquote class="layui-elem-quote"> This floating point value specifies the importance that interpolation of the point samples is given in the formulation of the screened Poisson equation.</blockquote>
          </div>
        </div>
