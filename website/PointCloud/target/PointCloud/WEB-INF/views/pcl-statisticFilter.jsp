...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      ...
      <form class="layui-form" action="doStatisticFilter">

        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">设置统计滤波的K-means 近邻数目</label>
            <div class="layui-input-inline">
              <input value = 50 style="width: 50px" type="tel" name="kmeans"  autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-inline">
            <label class="layui-form-label">设置统计滤波时的阈值</label>
            <div class="layui-input-inline">
              <input value = 1.0 style="width: 50px" type="tel" name="thres"  autocomplete="off" class="layui-input">
            </div>
          </div>
        </div>
