...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <form class="layui-form" action="getParam-3">
      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">各向异性等级</label>
          <div class="layui-input-inline">
            <input value = 0.0 style="width: 50px" type="tel" name="isoLevel"  autocomplete="off" class="layui-input">
          </div>
        </div>
        <div class="layui-inline">
          <label class="layui-form-label">设置方格分辨率</label>
          <div class="layui-input-inline">
            <input value = 8 style="width: 50px" type="tel" name="gridResolution"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>
      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">设置方格移动百分比(PercentageExtendGrid)</label>
          <div class="layui-input-inline">
            <input value = 0.0 style="width: 50px" type="tel" name="PercentageExtendGrid"  autocomplete="off" class="layui-input">
          </div>
        </div>
