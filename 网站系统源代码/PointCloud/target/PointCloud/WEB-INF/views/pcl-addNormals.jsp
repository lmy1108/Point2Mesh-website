...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <blockquote class="layui-elem-quote">ply文件的头文件一般由三个域构成，分别为：点云x,y,z / 法向量nx,ny.nz / 颜色R,G,B,其中nx,ny,nz在一些ply点云中未定义，需要计算以后才能用jhu等算法进行表面重建</blockquote>
    ...
    <form class="layui-form" action="addNormalFunc">
