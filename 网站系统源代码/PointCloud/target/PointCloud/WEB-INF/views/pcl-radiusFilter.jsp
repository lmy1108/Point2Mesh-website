...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      ...
      <form class="layui-form" action="doRadiusFilter">

      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">设置半径滤波时的半径搜索区域</label>
          <div class="layui-input-inline">
            <input value = 0.8 style="width: 50px" type="tel" name="radius"  autocomplete="off" class="layui-input">
          </div>
        </div>
        <div class="layui-inline">
          <label class="layui-form-label">设置半径滤波时的最小相邻结点</label>
          <div class="layui-input-inline">
            <input value = 2 style="width: 50px" type="tel" name="neighbor"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>
