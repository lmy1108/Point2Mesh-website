...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      ...
      <form class="layui-form" action="getParam-2">
      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">参数degree 范围[1,5]</label>
          <div class="layui-input-inline">
            <input value = 2 style="width: 50px" type="tel" name="degree"  autocomplete="off" class="layui-input">
          </div>
        </div>
        <div class="layui-inline">
          <label class="layui-form-label">树的最大深度</label>
          <div class="layui-input-inline">
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">用于提取ISO等值面的算法的深度</label>
          <div class="layui-input-inline">
            <input value = 8 style="width: 50px" type="tel" name="isoDivide"  autocomplete="off" class="layui-input">
          </div>
        </div>
        <div class="layui-inline">
          <label class="layui-form-label">落入一个八叉树结点中的样本点的最小数量</label>
          <div class="layui-input-inline">
            <input value = 3.0 style="width: 50px" type="tel" name="samples"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>
      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">用于重构的立方体直径和样本边界立方体直径的比率</label>
          <div class="layui-input-inline">
            <input value = 1.25 style="width: 50px" type="tel" name="scale"  autocomplete="off" class="layui-input">
          </div>
        </div>
        <div class="layui-inline">
          <label class="layui-form-label">Gauss-Seidel迭代方法的深度</label>
          <div class="layui-input-inline">
            <input value = 8 style="width: 50px" type="tel" name="solverDivide"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>

      <div class="layui-form-item">
        <label class="layui-form-label">是否使用法向量的大小作为置信息</label>
        <div class="layui-input-block">
          <input type="checkbox" name="confidence" lay-skin="switch" lay-text="ON|OFF">
        </div>
      </div>
        <div class="layui-form-item">
          <label class="layui-form-label">是否添加多边形的重心</label>
          <div class="layui-input-block">
            <input type="checkbox" name="manifold" lay-skin="switch" lay-text="ON|OFF">
          </div>
        </div>
