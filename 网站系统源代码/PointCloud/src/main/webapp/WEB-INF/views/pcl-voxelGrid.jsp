  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      <%--<div class="layui-form-item">--%>
        ...
        <%--</div>--%>
      <%--</div>--%>
    <br/><blockquote class="layui-elem-quote">PCL实现的VoxelGrid类通过输入的点云数据创建一个三维体素栅格（可把体素栅格想象为微小的空间三维立方体的集合），然后在每个体素（即，三维立方体）内，用体素中所有点的重心来近似显示体素中其他点，这样该体素就内所有点就用一个重心点最终表示，对于所有体素处理后得到过滤后的点云。这种方法比用体素中心来逼近的方法更慢，但它对于采样点对应曲面的表示更为准确。</blockquote>
    ...
    <form id="myform"  method="post" >
      ...
      <form class="layui-form" action="doVoxelGrid">

      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">设置体素化滤波时的三维立方体边长</label>
          <div class="layui-input-inline">
            <input value = 0.01 style="width: 50px" type="tel" name="length"  autocomplete="off" class="layui-input">
          </div>
        </div>
