  ...
  <div class="layui-body">
    ...
    <%--<form class="layui-form" action="">--%>
      <%--<div class="layui-form-item">--%>
        ...
        <%--</div>--%>
      <%--</div>--%>
    <br/><blockquote class="layui-elem-quote">Surface Trimmer是对生成的网格进行优化处理的程序，对于一些生成的网格，此程序会根据参数检测其稀薄的部分，并进行剪切，具体参数定义请见http://www.cs.jhu.edu/~misha/Code/PoissonRecon/Version9.011/</blockquote>
    ...
    <form id="myform"  method="post" >
      ...
      <form class="layui-form" action="trimmer">

      <div class="layui-form-item">
        <div class="layui-inline">
          <label class="layui-form-label">设置曲面剪切的阈值</label>
          <div class="layui-input-inline">
            <input value = 7 style="width: 50px" type="tel" name="param"  autocomplete="off" class="layui-input">
          </div>
        </div>
